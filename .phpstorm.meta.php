...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\Dev\informatique\Promotion sociale\2024-2025\Projet dev SGBD\projet\projetTest\public\storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\Dev\\informatique\\Promotion sociale\\2024-2025\\Projet dev SGBD\\projet\\projetTest\\public\\storage','logging.default','logging.deprecations.channel',
...
'debugbar.queries.explain','welcome.index','hello','cars.index',
'user.index','calcul.index','language.index','formulaire',
'accueil.index','about.index','membre.index','service.index','produit.index',
'produit.index','task.index','task.add','task.delete','task.show',
'task.store','storage.local',);
        registerArgumentsSet('views', 
'about','accueil','calcul','cars','components.card',
'components.produitcomponent','langue','membre','product-detail','produit',
'service','task','task-detail','task-form','user',
